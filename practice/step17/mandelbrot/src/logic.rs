fn get_n_diverget(x0: f64, y0: f64, max_iter: usize) -> u8 {
...
pub fn generate_mandelbrot_set(
    ...
    for i in 0..canvas_h {
        ...
        for j in 0..canvas_w {
            ...
            let iter_index = get_n_diverget(x, y, max_iter);
...
mod tests {
    ...
    fn test_get_n_diverged() {
        let max_iter = 10;
        assert_eq!(get_n_diverget(1.0, 0.0, max_iter), 3);
        assert_eq!(get_n_diverget(0.0, 0.0, max_iter), max_iter as u8);
        assert_eq!(get_n_diverget(0.0, 1.0, max_iter), max_iter as u8);
    }
